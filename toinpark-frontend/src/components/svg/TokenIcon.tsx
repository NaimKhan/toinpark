function TokenIcon({ ...props }: React.ComponentProps<"svg">) {
  return (
    <svg
      width="24"
      height="24"
      ...
      {...props}
    >
      <g clipPath="url(#clip0_1575_1784)">
        <g clipPath="url(#clip1_1575_1784)">
          <mask
            id="mask0_1575_1784"
      ...
      <defs>
        <clipPath id="clip0_1575_1784">
          <rect width="24" height="24" fill="currentColor" />
        </clipPath>
        <clipPath id="clip1_1575_1784">
          <rect width="24" height="24" fill="currentColor" />
        </clipPath>
      </defs>
    </svg>
