function SupportIcon({ ...props }: React.ComponentProps<"svg">) {
  return (
    <svg
      ...
      {...props}
    >
      <g clipPath="url(#clip0_1575_1814)">
        <mask
          id="mask0_1575_1814"
        ...
        <g mask="url(#mask0_1575_1814)">
          ...
          <path
            opacity="0.4"
            d="M7.64949 3.09055C7.28949 4.31055 7.02949 5.55055 6.81949 6.81055C5.52949 7.01055 4.24949 7.33055 2.97949 7.71055C3.94949 5.70055 5.55949 4.05055 7.54949 3.06055C7.57949 3.06055 7.61949 3.09055 7.64949 3.09055Z"
            fill="currentColor"
          />
          <path
          ...
          />
          <path
            d="M6.59 15.4898C5.21 15.2398 3.85 14.9198 2.53 14.4698C2.45 14.4498 2.39 14.4598 2.31 14.4498C2.12 13.6598 2 12.8498 2 11.9998C2 11.1598 2.12 10.3398 2.31 9.55976C2.39 9.54976 2.45 9.54977 2.53 9.52977C3.86 9.08977 5.21 8.75977 6.59 8.50977C6.34 10.8298 6.34 13.1698 6.59 15.4898Z"
            fill="currentColor"
          />
          <path
            d="M22.0002 11.9998C22.0002 12.8498 21.8802 13.6598 21.6902 14.4498C21.6102 14.4598 21.5502 14.4498 21.4702 14.4698C20.1402 14.9098 18.7802 15.2398 17.4102 15.4898C17.6702 13.1698 17.6702 10.8298 17.4102 8.50977C18.7802 8.75977 20.1502 9.07977 21.4702 9.52977C21.5502 9.54977 21.6102 9.55976 21.6902 9.55976C21.8802 10.3498 22.0002 11.1598 22.0002 11.9998Z"
            fill="currentColor"
          />
          <path
