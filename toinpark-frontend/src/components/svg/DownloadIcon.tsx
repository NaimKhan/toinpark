function DownloadIcon({ ...props }: React.ComponentProps<"svg">) {
  return (
    <svg
      ...
      {...props}
    >
      <g clipPath="url(#clip0_1575_1873)">
        <mask
          id="mask0_1575_1873"
        ...
        <g mask="url(#mask0_1575_1873)">
          ...
          />
          <path
            d="M8.99994 17.7495C8.80994 17.7495 8.61994 17.6795 8.46994 17.5295L6.46994 15.5295C6.17994 15.2395 6.17994 14.7595 6.46994 14.4695C6.75994 14.1795 7.23994 14.1795 7.52994 14.4695L9.52994 16.4695C9.81994 16.7595 9.81994 17.2395 9.52994 17.5295C9.37994 17.6795 9.18994 17.7495 8.99994 17.7495Z"
            fill="currentColor"
          />
          <path
