...
type DirectMemberTeamTableProps = {
  memberId: string;
};

export default function DirectMemberTeamTable({ memberId }: DirectMemberTeamTableProps) {
  ...
  const directMemberTeamPagination = teamData?.meta;
      ...
      >
        ...
        <DefaultTable.Footer>
          <BasicPagination
            ...
            totalPages={directMemberTeamPagination?.totalPages}
            hasNext={directMemberTeamPagination?.hasNext}
            hasPrevious={directMemberTeamPagination?.hasPrevious}
          />
        </DefaultTable.Footer>
      </RenderData>
    </DefaultTable>
