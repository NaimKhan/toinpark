...
export default function BlockedMemberTable() {
  ...
  const blockMembersData = getMembersRes?.data?.items;
  const blockMembersPagination = getMembersRes?.data?.meta;
  return (
    <DefaultTable
      data={blockMembersData}
      columns={columns}
      ...
      >
        ...
        <DefaultTable.Footer>
          <BasicPagination
            ...
            totalPages={blockMembersPagination?.totalPages}
            hasNext={blockMembersPagination?.hasNext}
            hasPrevious={blockMembersPagination?.hasPrevious}
          />
        </DefaultTable.Footer>
      </RenderData>
    </DefaultTable>
