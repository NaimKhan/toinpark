        ...
        <Dialog>
          <DialogTrigger asChild>
            <Button
              ...
              className="p-0 text-primary hover:text-primary hover:underline cursor-pointer font-medium bg-transparent hover:bg-transparent border-0 focus:outline-none h-auto"
            >
