...
import { useUpdateTicketCategoryFeatureMutation } from "@/store/api/tickets-categories/tickets-categories-api";
...
export default function StatusCell({
  ...
  const [updateTicketCategoryStatus, { isLoading }] =
  ...
  const executeStatusUpdate = async () => {
    ...
    try {
      await updateTicketCategoryStatus({ id: original.id }).unwrap();
      toastId.update({
        id: toastId.id,
        variant: "success",
        title: "Success",
      ...
      toastId.update({
        ...
        title: "Error",
        description:
          getApiMessage(error) || "Failed to update ticket category status.",
      });
    }
  };
