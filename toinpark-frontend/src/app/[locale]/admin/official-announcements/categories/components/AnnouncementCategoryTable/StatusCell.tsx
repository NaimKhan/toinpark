...
import { useUpdateAnnouncementCategoryStatusMutation } from "@/store/api/announcement-categories/announcement-categories-api";
...
export default function StatusCell({
  ...
  const [updateAnnouncementCategoryStatus, { isLoading }] =
  ...
  const executeStatusUpdate = async () => {
    ...
    try {
      await updateAnnouncementCategoryStatus({
        id: original.id,
      ...
      toastId.update({
        ...
        variant: "success",
        title: "Success",
        description: "Announcement category status updated successfully",
      });
  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <ConfirmDialog
        ...
        title="Change Status"
        description={`Are you sure you want to ${original?.isActive ? "deactivate" : "activate"} this category?`}
