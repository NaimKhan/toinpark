...
import { useGetStakingAdjustmentsQuery } from "@/store/api/admin-staking/admin-staking-api";
import { TGetAdminStakesArgs } from "@/store/api/admin-staking/admin-staking.types";
import RenderData from "@/components/feature/loader/RenderData";
import BasicPagination from "@/components/pagination/basic-pagination";

function DeductFundHistoryTable() {
...
export default DeductFundHistoryTable;
